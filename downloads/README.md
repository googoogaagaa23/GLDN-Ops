...
- [Download GLDN Ops v3.11.34](./GLDN-Ops-extension-v3.11.34.zip)

SHA-256: $extensionHash

## Current full local bundle

- [Download the GLDN Ops v3.11.34 local bundle](./GLDN-Ops-local-v3.11.34.zip)

SHA-256: $localHash

The complete machine-readable file list is in
[elease-manifest-v3.11.34.json](./release-manifest-v3.11.34.json).