  ...
  "features": [
    {
      ...
      "matrix": "C-13",
      "title": "Removed Listing History",
      "status": "PARTIAL",
      "summary": "Learn from eBay's previous listing violations and share product-level prevention history across GLDN profiles.",
      "prerequisites": [
        "Use the intended signed-in eBay Chrome profile.",
        "Update GLDN Ops and connect every profile to the same dashboard."
      ],
      "steps": [
        "Open Removed Listing History in the popup.",
        "Choose Scan This eBay Account. GLDN reads Inactive > View Listings and available case explanations.",
        "Wait for Shared history verified; Pause and Resume retain completed reads.",
        "Repeat on each eBay account. The combined history is checked before copying Ready links.",
        "Open Existing Listings and choose Refresh Policy Checks to apply the shared incidents to a saved audit."
      ],
      "approvalStop": "Read-only on eBay. This workflow never relists, appeals, revises or ends a listing.",
      "output": "Private shared Policy Incidents history with account, SKU/ASIN, product, exact notice and source links. Exact ASINs block; related wording needs review, not a declaration of illegality.",
      "recovery": [
      ...
      "evidence": "60 live incidents (56 ASINs) saved and read back from the deployed private dashboard; three case details read. Synthetic multi-page scanner and desktop/mobile UI checks pass. Full deployed multi-account validation remains pending."
    },
    {
      "id": "ops-health",
      "matrix": "F-02, F-11",
    ...
    },
    {
      ...
      "status": "IMPLEMENTED, LIVE REVIEW PENDING",
      "summary": "Scan existing listings and end selected flags in exact, approved batches.",
      "prerequisites": [
      ...
      "steps": [
        ...
        "If you ended directly on eBay, use Check eBay Result in GLDN. No second End approval is needed to check results.",
        "If some results remain unconfirmed, choose Set Aside Batch & Continue. Those exact items stay excluded while you select and review other Block or Review flags.",
        "After verified success, ended counts update and remaining selection stays queued. Each next batch needs fresh approval."
      ],
      "approvalStop": "No scan changes listings. Exact, one-use approval is required for each reviewed batch.",
      "output": "Exact-ID audit, bulk selection, native batch review, verified ended counts, remaining selection and CSV.",
      "recovery": [
    ...
    },
    {
      ...
      "steps": [
        ...
        "Start or Resume opens one reusable Profit Run Progress tab. Keep it open to see the current phase, current order or ASIN, exact and unresolved counts, errors, pause reason, and destination tab without interrupting the signed-in worker.",
        ...
        "After a confirmed, non-queued sync, GLDN Ops opens or focuses the actual Poshmark profit workbook. Use the progress page workbook buttons at any time to inspect existing saved rows; unsynced work never appears there.",
